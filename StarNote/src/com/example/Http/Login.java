...
public class Login extends AsyncHttpRequestSample {
	...
	LogInHttpRequest interfaceHttpRequest;
	
	public Login(Context context, String username, String password, LogInHttpRequest i) {
		super(context);
	...
	public ResponseHandlerInterface getResponseHandler() {
		return new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
				...
				if ( json.equals("1")) {
					//if data to received from server is 1, success.
            ...
            //when don't receive data to server,
            @Override
	...
	//send data to server, namely password and username.
	@Override
