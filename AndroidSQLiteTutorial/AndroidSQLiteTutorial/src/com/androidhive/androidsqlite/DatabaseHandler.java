...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	Contact getContact(int id) {
		...
		Cursor cursor = db.query(TABLE_CONTACTS, new String[] { KEY_ID,
				KEY_USERNAME, KEY_PH_NO, KEY_TYPE, KEY_DATE, KEY_DURATION }, KEY_ID + "=?",
	...
	public int updateContact(Contact contact) {
		...
		values.put(KEY_USERNAME, contact.getName());
		values.put(KEY_PH_NO, contact.getPhoneNumber());
		values.put(KEY_TYPE, contact.getPhoneNumber());
		values.put(KEY_DATE, contact.getPhoneNumber());
		values.put(KEY_DURATION, contact.getPhoneNumber());
